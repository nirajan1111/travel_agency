...
const Home1Testimonail = () => {
  ...
  const testimonial_data = [
    {
      quote: "The trekking experience in Nepal was truly life-changing. The breathtaking views, warm hospitality, and expert guidance made it an unforgettable journey.",
      rating: 5,
      date: "April 15, 2024",
      time: "10:00 AM",
    ...
    {
      quote: "Nepal exceeded all my expectations. From the towering peaks to the lush valleys, every moment was filled with wonder and adventure.",
      rating: 5,
      date: "March 28, 2024",
      time: "2:30 PM",
      author: "David Chen",
    ...
    {
      quote: "Trekking in Nepal was a dream come true. The guides were knowledgeable, the trails were stunning, and the experience was unforgettable.",
      rating: 5,
