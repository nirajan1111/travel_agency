...
const page = () => {
  return (
    <>
      <Topbar2 />
      <Header />
      <Breadcrumb pagename="Blog Standard" pagetitle="Blog Standard Sidebar" />
            ...
            <div className="col-lg-8 order-lg-2 order-1">
              <div className="blog-st-card mb-70">
                <div className="blog-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img
                      src="/assets/img/innerpage/blog-standard-img1.jpg"
                      alt=""
                    />
                  </Link>
                ...
                <div className="blog-content">
                  ...
                  <h2>
                    <Link href="/blog/blog-details">
                      Our Begin Now Todo Beingonl What Yourmt Will Be own fully
                      gone.
                    </Link>
                  </h2>
                  <p>
                    Aliquam erat volutpat. Ut scelerisque elementum nisi, a
                    fermentumon odiona gouvikoi turban tincidunat vel. Proin
                    velit est, elementum sed hendrerit quisesa mattis at nisol.
                    Morbus condimentum massa ideng tellus fringilla.
                  </p>
                  <Link href="/blog/blog-details">
                    View Post
                    <span>
              ...
              <div className="blog-st-card mb-70">
                ...
                <div className="blog-content">
                  ...
                  <h2>
                    <Link href="/blog/blog-details">
                      Fusce viverra quis nulla vitae sollicitudint Duis auctor
                      mauris sed.
                    </Link>
                  </h2>
                  <p>
              ...
              <div className="blog-st-card mb-70">
                <div className="blog-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img
                      src="/assets/img/innerpage/blog-standard-img3.jpg"
                      alt=""
                    />
                  </Link>
                  <Link href="/blog" className="date">
                ...
                <div className="blog-content">
                  ...
                  <h2>
                    <Link href="/blog/blog-details">
                      Etiam maximus imperdiet purus at hendre neque consectetur
                      nec.
                    </Link>
                  </h2>
                  <p>
